...
from .VAEModel import TFVAEModel
from .VAEModel_parellel import TFVAEModel_parallel
from .VaTModel import VAETModel
...
def setup(opt):
    ...
    # VAE
    elif opt.caption_model == 'tfvae':
        model = TFVAEModel(opt)
    elif opt.caption_model == 'tfvae_parallel':
        model = TFVAEModel_parallel(opt)
    elif opt.caption_model == 'vat':
        model = VAETModel(opt)
    else:
