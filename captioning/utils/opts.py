...
def parse_opt():
    ...
    parser.add_argument('--kl_beta', type=float, default=1.0,
                        help='')
    parser.add_argument('--gmm_num', type=int, default=1,
                        help='')
    ...
    parser.add_argument('--sample_logprobs', action='store_true', default=False,
                    help='sample logprobs giving groundtruth as inputs')
    ...
    parser.add_argument('--sc_beam_size', type=int, default=1,
                    help='')
    parser.add_argument('--sc_baseline', type=str, default='avg',
                        help='baseline method, options: avg|mid|mix')

    # Used for focal loss and ghm loss
    parser.add_argument('--use_ghmloss', action='store_true', default=False,
                        help='use ghm loss in lm crit')
    parser.add_argument('--use_focalloss', action='store_true', default=False,
                        help='use focal loss in lm crit')
    parser.add_argument('--focal_gamma', type=int, default=2,
                        help='gamma in focal loss')
    parser.add_argument('--focal_alpha', type=int, default=0.25,
                        help='alpha in focal loss')
    parser.add_argument('--pos_only', action='store_true', default=False,
                        help='using sc optimization only for positive scores')
